...
namespace Cmsql.Test.Grammar.Parsing
{
    public class CmsqlQueryParserTest
    {
        ...
        public void Test_can_parse_single_query_without_terminator()
        {
            ...
            var query = parseResult.Queries.First();
        ...
        public void Test_can_parse_multiple_queries()
        {
            ...
            var firstQuery = parseResult.Queries.First();
            ...
            var secondQuery = parseResult.Queries.ElementAt(1);
            ...
            var condition = secondQuery.Criteria as CmsqlQueryCondition;
            ...
            var thirdQuery = parseResult.Queries.ElementAt(2);
